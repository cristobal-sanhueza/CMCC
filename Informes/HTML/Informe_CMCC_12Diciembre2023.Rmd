...
CMCC_Observados <- read_excel("/Users/cristobal512/Desktop/geoaire/CMCC/Observados/CMCC_website/CMCC_01Diciembre2023-31Diciembre2023.xlsx")
...
df <- data.frame(`Nº Proyecto` = c("G12-21"),
                 Elaboración = paste('ESM', '08-01-2024'),
                 Revisión = paste('MTV', '08-01-2024'),
                 Aprobó = paste('PSH', '08-01-2024'),
                 Versión = "V1")
...
<div style="display: flex; justify-content: space-between;">
  <div>Evelyn Salazar M.</div>
  <div>Ingeniero Geografo</div>
</div>
...
El análisis estadístico de las concentraciones de MP10 observados y medidos en la estación Campamento se muestra en la tabla III.4. De ella se observa que el MFE está fuera del rango por poco y el MFB se encuentra dentro del rango. En general el modelo presenta un buen desempeño.
