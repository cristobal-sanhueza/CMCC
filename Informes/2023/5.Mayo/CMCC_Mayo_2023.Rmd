...
CMCC_Mayo_Obs <- read_excel("CMCC/Observados/2023/5.Mayo/Informe.xlsx")
...
df <- data.frame(`Nº Proyecto` = c("G12-21"),
                 Elaboración = c("CSD 08-06-23"),
                 `Revisión A` = c("MTV 08-06-23"),
                 Aprobó = c("PSH 08-06-23"),
                 Versión = "V1")
