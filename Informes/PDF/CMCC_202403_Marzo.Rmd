...
MesDelReporte = "marzo" # en minúscula
  
FechaEntrega = "Abril 2024" # mayúscula la inicial
...
CMCC_Obs <- read_excel("/Users/cristobal512/Desktop/geoaire/CMCC/Observados/CMCC_website/CMCC_202403_Marzo.xlsx")
...
La Tabla III.5 muestra la Exactitud del modelo de pronóstico para el período evaluado en la estación Campamento. De ella se observa que en promedio, el acierto del modelo es de un `r label_percent(1)(promedio)`, para el período de `r MesDelReporte` 2023.
